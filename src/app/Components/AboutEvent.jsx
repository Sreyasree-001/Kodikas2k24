const AboutEvent = () => {
    return (
      ...
      <div id="about-event" className="px-4 py-16 mx-auto sm:max-w-xl md:max-w-full lg:max-w-screen-xl md:px-20 lg:px-5 lg:py-50 bg-[url('/bg2.jpg')] bg-cover flex flex-col items-center justify-center">

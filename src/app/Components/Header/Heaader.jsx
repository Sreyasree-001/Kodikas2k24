...
const Header = () => {
  return (
    <div className="w-full min-h-screen bg-[url('/homeback.jpg')] bg-cover bg-center bg-no-repeat 
        ...
        <div className="flex flex-col items-center justify-center mb-16 text-center sm:mb-0">
          <div className="max-w-xl mb-10 md:mx-auto sm:text-center lg:max-w-2xl md:mb-12">
            ...
            <p className="text-base text-gray-300 md:text-lg">
               Organized by the Computer Science & Engineering Department<br />
              of MCKV Institute of Engineering
            </p>
          </div>
          <div>
            <button className="overflow-hidden relative w-32 p-2 h-12 bg-black text-white border-none rounded-md text-xl font-bold cursor-pointer relative z-2 group">
              <a href="/register">
                ...
                Click Here
                <span className="group-hover:opacity-100 group-hover:duration-1000 duration-100 opacity-0 absolute top-2.5 left-6 z-10">Register!</span>
              </a>
            </button>
          </div>
        </div>
